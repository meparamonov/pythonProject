...
#     gr = input("Введите год рождения: ")
#     gor = input("Введите город: ")
#     email = input("Введите почту: ")
#     phone = input("Введите телефон: ")
#     return (f'Ваше Имя: {name}, Фамилия: {name2}, год рождения: {gr}, город: {gor}, почта: {email}, номер телефона: {phone}')
#
# print(myf2())
...
маленьких латинских букв и возвращающую их же, 
...
разделённых пробелом. Каждое слово состоит 
